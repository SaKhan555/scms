	...
	<div class="card-header">
		...
		<div class="float-right">
			<div class="dropdown">
				...
				<button type="button" data-id="{{ $item->id }}" class="dropdown-item btn btn-primary btn_edit"><i class="fa fa-edit"></i> Edit </button>
					<a class="dropdown-item" href="" title="Generate Details PDF"><i class="fa fa-file"></i> Generate
						PDF</a>
					<a class="dropdown-item" href="{{ route('admin.item.index') }}" title="Close"><i
		...
		<div class="row">
			<div class="col-md-8">
				<table class="table table-striped table-bordered">
					...
					<tr>
						<th>Item Category</th>
						<td>{{ ucfirst($item->item_category->name) }}</td>
					</tr>
					<tr>
						<th>Details</th>
